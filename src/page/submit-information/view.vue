  ...
  <div class="myapp">
    ...
    <div class="add-form">
      <group>
        ...
        <selector title="机构类型" direction="left" v-if="!read" required ref='ubusinesstype'  v-model="item.ubusinesstype" :value-map="['BDID','Value']" :options="tbsysbasicdatabycode" placeholder="请选择"></selector>
...
,
  ...
  methods: {
    submit() {
      ...
      if (that.$refs['ubusinesstype'].getFullValue().length != 0)
